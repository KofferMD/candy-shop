...
import emptyCartImg from '../assets/img/vector.png'
...
function Cart() {
    ...
    const addedCandyes = Object.keys(items).map(key => {
    ...
    const onClickOrder= () => {
        console.log("ВАШ ЗАКАЗ ПРИЯНТ", items)
    }
